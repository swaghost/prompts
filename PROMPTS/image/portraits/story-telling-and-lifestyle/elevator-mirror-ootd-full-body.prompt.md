---
name: Elevator Mirror OOTD (full-body)
description: This prompt generates a detailed visual description of an adult woman taking a full-body mirror selfie in an elevator. It captures specific details of appearance, pose, setting, and mood to ensure a photorealistic and stylish outcome. Ideal for artists and creators looking to depict everyday, candid moments with a chic vibe.
---
{
